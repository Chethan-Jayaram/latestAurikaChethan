...
public class SleepWellModle {
    ...
    @Expose
    private List<SleepwellList> details = null;
    ...
    public List<SleepwellList> getDetails() {
        return details;
    }

    public void setDetails(List<SleepwellList> details) {
