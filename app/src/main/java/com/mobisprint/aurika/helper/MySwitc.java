...
public class MySwitc extends View {
    ...
    public MySwitc(Context context) {
        super(context);
        initView();
    }

    public MySwitc(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
        initProperties(attrs);
    }

    public MySwitc(Context context, AttributeSet attrs, int defStyleAttr) {
...
*/
    ...
    public interface OnToggledListener {
        ...
        void onSwitched(MySwitc labeledSwitch, boolean isOn);
    }
