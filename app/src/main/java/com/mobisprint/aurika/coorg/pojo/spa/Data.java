...
public class Data {
    ...
    public List<SpaMenu> getSpaMenuList() {
        return spaMenuList;
    }

    public void setSpaMenuList(List<SpaMenu> spaMenuList) {
        this.spaMenuList = spaMenuList;
    }
    ...
    @SerializedName("spa_menu_list")
    @Expose
    private List<SpaMenu> spaMenuList = null;
